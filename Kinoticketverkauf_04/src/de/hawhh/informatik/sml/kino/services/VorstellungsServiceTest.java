...
public class VorstellungsServiceTest
{
    ...
    public void testeKonstruktor()
    {
        ...
        assertEquals(Geldbetrag.gibBetrag(1230), v.getPreis());
    ...
    public void testeGibPreisFuerPlaetze()
    {
        ...
        assertEquals(Geldbetrag.gibBetrag(0), v.getPreisFuerPlaetze(s));

        s.add(Platz.get(5, 5));
        s.add(Platz.get(5, 6));
        s.add(Platz.get(5, 7));

        assertEquals(Geldbetrag.gibBetrag(3690), v.getPreisFuerPlaetze(s));
    }
